...
# ROM-free artifacts to bundle (committed under prebuilt/, regenerated by
# `make GAME=mooncrst adf`). They contain no ROM.
datas = [('prebuilt/mooncrst', '.'), ('prebuilt/mooncrst.adf', '.')]
binaries = []
